...
# student-t
# 'params': (2.9627974626468583, 0.0010966322707605593, 0.014871990244979628)
#
def pdf(x, mu, sigma):
    ...
    return norm.pdf(x, loc=0.0007434863924427764, scale=0.025366014680940803)
...
plt.hist(cdf_inverse_Z2, histtype='step', color='green', density=True, bins=100, label=r'$F^-1(z)$')
...
mu2 = (np.mean(returns2) / multiplier) * (1.0 / dt)
print('-- simulado --')
print(mu2)
print(sigma2)
